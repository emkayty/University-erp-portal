...
export default function ClearancePage() {
  ...
  return <div className="erp-workspace-page">
    ...
    {!isStudent && <Card className="erp-control-rail"><CardContent className="pt-5"><form onSubmit={(e) => { e.preventDefault(); setStudentId(inputId.trim()); }} className="flex flex-col gap-3 sm:flex-row"><Input value={inputId} onChange={(e) => setInputId(e.target.value)} placeholder="Student UUID" required /><Button type="submit">Load clearance</Button></form></CardContent></Card>}
